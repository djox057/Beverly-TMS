-- Fix the search_path security issue and syntax error for the create_order_with_unique_load_number function
CREATE OR REPLACE FUNCTION create_order_with_unique_load_number(order_data jsonb)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY definer
