...
const Reports = () => {
  ...
  const renderTruckCalendarCells = (truck: any, startDate: Date, truckIndex: number, totalTrucks: number) => {
    ...
    return days.map((day, index) => {
      ...
      return <td key={index} className={`${isToday ? (isLastTruck ? '' : 'border-b-2 border-gray-300') : 'border-b-2 border-gray-300'} ${showLeftBorder ? 'border-l border-gray-300' : ''} p-0 relative`} style={{
        width: '120px',
        minWidth: '120px',
        maxWidth: '120px',
        verticalAlign: 'top',
                    ...
                    <tbody>
                      {group.trucks.map((truck, truckIndex) => {
                        ...
                        return <tr key={truck.id} className={truckIndex % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}>
                          <td className="border-r border-b-2 border-gray-300 px-2 py-1 text-xs text-gray-900 font-medium" style={{
                      width: '64px',
                      minWidth: '64px',
                      maxWidth: '64px'
                    }}>
                          ...
                          <td className="border-r border-b-2 border-gray-300 px-2 py-1 text-xs text-gray-900" style={{
                      width: '163px',
                      minWidth: '163px',
                      maxWidth: '163px'
                    }}>{truck.driver}</td>
                      ...
                      maxWidth: '136px'
                          ...
                          <td colSpan={4} className="border-r border-b-2 border-gray-300 p-0" style={{
                      height: '64px'
                    }}>
                           ...
                           <td className="border-b-2 border-gray-300 px-2 py-1 text-[10px] text-gray-600" style={{
                      width: '80px',
                      minWidth: '80px',
                      maxWidth: '80px'
                    }}>{truck.lastEdit}</td>
                           <td className={`border-b-2 border-gray-300 px-2 py-1 text-[10px] text-gray-600 ${sidebarOpen ? 'border-r border-gray-300' : ''}`} style={{
                      width: '80px',
                      minWidth: '80px',
                      maxWidth: '80px'
                    }}>{truck.editDate}</td>
