                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              variant="ghost"
                              size="sm"
                              className={`absolute top-[3.5%] ${isToday ? 'right-[7%]' : 'right-[1.5%]'} h-2.5 w-2.5 p-0 hover:bg-background/20`}
                            >
                  ...
                  {pickupOnlyOrders.map((order, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button variant="ghost" size="sm" className={`absolute top-[3.5%] ${isToday ? 'right-[7%]' : 'right-[1.5%]'} h-2.5 w-2.5 p-0 hover:bg-background/20`}>
                              <Info className="h-2 w-2" />
                            </Button>
                          </PopoverTrigger>
                          <PopoverContent className="w-80 z-[102]">
