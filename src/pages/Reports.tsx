      ...
      return <td key={index} className={`border-b-[3px] border-gray-400 ${showLeftBorder ? 'border-l border-gray-300' : ''} p-0 relative`} style={{
        ...
        ...(showRightBorder ? {
          ...
          height: '64px'
            ...
            <div className={`${isToday ? '' : 'border-l border-r'} border-border flex flex-col ${pickupOnlyOrders.length > 0 || sameDayOrders.length > 0 ? '' : isMissingPickup ? 'bg-[hsl(0_72%_53%)] dark:bg-[hsl(var(--destructive-light))]' : isInTransit ? 'bg-[hsl(var(--cell-loading))]' : 'bg-muted'}`} style={{
            height: '32px',
            minHeight: '32px',
            maxHeight: '32px'
          }}>
