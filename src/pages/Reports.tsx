                      ...
                      {group.trucks.map((truck, index) => (
                        <>
                          <tr key={truck.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}>
                            ...
                            {/* Split cells for Away, Drive, Shift, Cycle with Notes at bottom merged */}
                          ...
                          <tr key={`${truck.id}-notes`} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}>
                            <td className="border-r border-gray-300"></td>
                            <td className="border-r border-gray-300"></td>
                            <td className="border-r border-gray-300"></td>
                            {Array.from({ length: 5 }).map((_, dayIndex) => (
                              <td key={dayIndex} className="border-r border-gray-300"></td>
                            ))}
                            <td colSpan={4} className="border-r border-gray-300 px-1 py-1 text-center" style={{ height: '64px' }}>
