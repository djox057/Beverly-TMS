      ...
      return (
        ...
        >
          ...
          >
            ...
            <div
              className={`border-b ${!isToday && index > 0 ? 'border-l' : ''} ${!isToday ? 'border-r' : ''} border-gray-400 ${deliveryOnlyOrders.length === 2 ? 'flex flex-row' : 'flex flex-col'} ${isToday ? 'px-[2%]' : ''} ${deliveryOnlyOrders.length > 0 ? "" : "bg-muted"}`}
              style={{
                height: "32px",
                minHeight: "32px",
                maxHeight: "32px",
            ...
            <div
              className={`${!isToday && index > 0 ? 'border-l' : ''} ${!isToday ? 'border-r' : ''} border-gray-400 ${(pickupOnlyOrders.length === 2 && sameDayOrders.length === 0) || (pickupOnlyOrders.length === 0 && sameDayOrders.length === 2) ? 'flex flex-row' : 'flex flex-col'} ${isToday ? 'px-[2%]' : ''} ${pickupOnlyOrders.length > 0 || sameDayOrders.length > 0 ? "" : isMissingPickup ? "bg-[hsl(0_72%_53%)] dark:bg-[hsl(var(--destructive-light))]" : "bg-muted"}`}
              style={{
                height: "32px",
                minHeight: "32px",
                maxHeight: "32px",
