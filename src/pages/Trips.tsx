...
const Trips = () => {
  ...
  const exportBFPrimeDriversTemplate = async (
    ...
    try {
      ...
      const response = await fetch("/templates/BF_Prime-4.xlsx");
  ...
  const exportBeverlyFreightTemplate = async (
    ...
    try {
      ...
      const response = await fetch("/templates/Beverly_Freight-4.xlsx");
      const arrayBuffer = await response.arrayBuffer();
  ...
  const exportBGPrimeIncTemplate = async (
    ...
    try {
      ...
      const response = await fetch("/templates/BG_Inc-4.xlsx");
      const arrayBuffer = await response.arrayBuffer();
  ...
  const exportBFPrimeTemplate = async (
    ...
    try {
      // Load the template
      const response = await fetch("/templates/BF_Prime_United-4.xlsx");
      const arrayBuffer = await response.arrayBuffer();
