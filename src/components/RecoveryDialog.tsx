        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Textarea value={recoveryNote} onChange={e => setRecoveryNote(e.target.value)} placeholder="Enter recovery details..." className="min-h-[100px]" autoFocus />
            </div>
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button onClick={handleConfirm} disabled={!recoveryNote.trim() || isSubmitting}>
